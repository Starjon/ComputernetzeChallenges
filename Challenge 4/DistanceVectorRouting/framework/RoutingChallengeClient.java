...
public class RoutingChallengeClient implements Runnable {
    private String protocolString = "ROUTINGCHALLENGE/4.0";
                        ...
                        if (message.split(" ")[1].startsWith("DISCONNECTED")) {
                            ...
                            if (message.split(" ").length == 2) {
                                try {
                                    ...
                                    byte[] packetData = Base64.getDecoder().decode(message.split(" ")[1]);
    ...
    public TransmissionResult Transmit(Packet packet) {
        ...
        if (sendControlMessage("TRANSMIT " + Base64.getEncoder().encodeToString(packetBytes))) {
